    ...
    schemas: dict[str, Any] = {
        ...
        "FinancialSummaryResponse": {
            ...
            "properties": {
                ...
                "data": {
                    "type": "object",
                    "required": ["by_study_program", "by_student", "totals"],
                    "properties": {
                        "period": {"type": ["string", "null"]},
                        "study_program_id": {"type": ["string", "null"]},
                        "entry_period": {"type": ["string", "null"]},
                        "by_study_program": {"type": "array", "items": {"type": "object"}},
                        "by_student": {
                            "type": "array",
                            "items": {"$ref": "#/components/schemas/FinancialStudentSummary"},
                        },
                        "totals": {"type": "object"},
                    },
                },
        ...
        "FinancialStudentSummary": {
            ...
            "properties": {
                ...
                "briva": {
                    "type": "string",
                    "description": "Nomor BRIVA unik mahasiswa; beberapa nilai dipisahkan koma.",
                },
                "phone_number": {"type": "string"},
                "program_study": {"type": "string"},
                "entry_period": {"type": "string"},
                "total_bills": {"type": "integer"},
                "billed_amount": {"type": "integer"},
                "billed_amount_formatted": {"type": "string"},
                "paid_amount": {"type": "integer"},
                "paid_amount_formatted": {"type": "string"},
                "outstanding_amount": {"type": "integer"},
                "outstanding_amount_formatted": {"type": "string"},
                "percentage_paid": {"type": "number"},
