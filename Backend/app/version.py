"""Canonical application version loader and validator.

This module reads the single-source-of-truth application version from the root VERSION file,
validates that it adheres strictly to Semantic Versioning (SemVer 2.0.0), and provides APP_VERSION.
"""
...
def read_application_version(version_file: str | Path = VERSION_FILE) -> str:
    """Read and validate the repository's canonical application version from VERSION file."""
