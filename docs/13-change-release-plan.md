...
Audit 2026-08-21 menemukan tiga label berbeda: FastAPI/health `0.2.0`, changelog `2.3.0`, dan package SPA `1.0.0`. Sebelum release berikutnya, tetapkan satu source of truth version dan inject ke health, OpenAPI, frontend, changelog, serta dokumen. `release_id` Git tetap dipakai untuk identitas commit.
...
| Audit dependency npm dan Python terisolasi lulus. | Ya |
