...
Status audit 2026-08-21: M0-M4 memiliki implementasi utama, tetapi M5 belum lulus karena temuan High terbuka. M6 untuk perubahan Unreleased belum dimulai; deployment lama tidak membuktikan working tree saat ini sudah production-ready.

Backlog P0 saat ini adalah permission payment history, pagination SPA, kewajiban nominal partial, dan hardening Docker. Backlog arsitektur berikutnya adalah migration lifecycle, transaction audit atomik, dan penyelarasan RBAC viewer.
