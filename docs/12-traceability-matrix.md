...
| FR-005 | Nama mahasiswa tidak tampil pada hasil lookup publik. | `docs/06-security-privacy-design.md` | `students.full_name` | `/api/lookup` | TC-006, ST-005 | Implemented |
...
| SEC-003 | Response publik tidak mengirim nama mahasiswa. | `docs/06-security-privacy-design.md` | `students` | `/api/lookup` | ST-005 | Implemented |
