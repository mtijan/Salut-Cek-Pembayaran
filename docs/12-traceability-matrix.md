...
| FR-005 | Lookup publik menampilkan informasi mahasiswa dan pembayaran. | `docs/06-security-privacy-design.md` | `students.nim`, `students.full_name` | `/api/lookup` | TC-006, ST-005 | Implemented |
